...
if __name__ == '__main__':
    ...
    while Fitness < .98:
        ...
        for i in En.Combos:
            ...
            for Game in Rost.Games:
                ...
                if outcome == WINNING_SCORE:
                    ...
                    SD = abs(Game.teams[0].ScoreDif - AI.slr)
        ...
        # go over all ai models and see witch one is closest to zero
        curAi = AiKeepers[0]

        for ai in AiKeepers:
            if ai.Score < curAi.Score:
                curAi = ai
